    ...
    <main class="flex-grow py-8">
        <div class="container mx-auto p-6 bg-white shadow-lg rounded-lg max-w-5xl">
            <div class="flex justify-between items-center mb-4">
                ...
                <Link href="/roles/create" class="bg-gray-600 text-white px-3 py-2 font-semibold text-sm rounded hover:bg-gray-700">
            ...
            <table class="min-w-full bg-white">
                ...
                <tr v-for="role in roles.data" :key="role.id">
                    ...
                    <td class="py-2 px-4 border-b">
                        ...
                        <button @click="deleteResource(role.id)" class="text-red-600 hover:underline"><i class="fas fa-trash-alt"></i></button>
                    </td>
                </tr>
                </tbody>
            </table>
            <div class="flex justify-center"><Pagination :links="roles.links" class="mt-6" /></div>
        </div>
...
const confirmDelete = () => {
    form.delete(`roles/${resourceToDelete.value}`);
